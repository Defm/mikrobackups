...
/interface wifi configuration add chains="" channel=5CH-AX-140 country=Russia disabled=no hw-protection-mode=rts-cts installation=indoor max-clients=20 mode=ap multicast-enhance=enabled name=RU-AP-5 qos-classifier=priority security=wpa3-security ssid=LocalWiFi5 steering=same-ssid steering.neighbor-group=dynamic-LocalWiFi-e5e02ae3 tx-chains="" tx-power=20
