...
# 
set caps-man-addresses=192.168.90.1 caps-man-certificate-common-names=anna.capsman@CHR certificate=C.wap.capsman@CHR discovery-interfaces="main infrastructure" enabled=yes interfaces="wlan 2Ghz,wlan 5Ghz" lock-to-caps-man=yes
