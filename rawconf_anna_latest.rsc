# 2026-01-20 15:20:02 by RouterOS 7.20
...
/ip dns set allow-remote-requests=yes cache-max-ttl=1d cache-size=4096KiB doh-max-concurrent-queries=100 doh-max-server-connections=20 max-concurrent-queries=200 max-concurrent-tcp-sessions=30 mdns-repeat-ifaces=main-infrastructure-br query-server-timeout=3s servers=217.10.36.5 use-doh-server=https://1.1.1.1/dns-query
/ip dns adlist add url=https://adguardteam.github.io/HostlistsRegistry/assets/filter_4.txt
/ip dns adlist add url=https://adguardteam.github.io/HostlistsRegistry/assets/filter_9.txt
/ip dns adlist add url=https://adguardteam.github.io/HostlistsRegistry/assets/filter_23.txt
/ip dns adlist add url=https://adguardteam.github.io/HostlistsRegistry/assets/filter_33.txt
